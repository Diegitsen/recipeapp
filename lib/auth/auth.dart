...
class Auth implements BaseAuth{
  ...
  Future<String> signUpEmailPassword(Usuario usuarioModel) async {
    //check this out
    FirebaseUser user = (await _firebaseAuth.createUserWithEmailAndPassword(email: usuarioModel.email, password: usuarioModel.password)) as FirebaseUser;
    ...
    await user.sendEmailVerification().then((onValue) => print('Email de verificacion enviado'))
        .catchError((onError)=> print('Error de Email de verificacionn: $onError'));
